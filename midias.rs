...
pub struct Genero {
    ...
    sigla: String,
    codigo: u16,
    lista_id_midias: Vec<String>,
}
impl Genero {
    pub fn new(nome: String, sigla: String, codigo: u16, lista_id_midias: Vec<String>) -> Genero {
        Genero {
            nome: nome,
            sigla: sigla,
            codigo: codigo,
            lista_id_midias: lista_id_midias,
        }
    }
    pub fn get_nome(&self) -> &String { &self.nome }
    pub fn get_sigla(&self) -> &String { &self.sigla }
    pub fn get_codigo(&self) -> &u16 { &self.codigo }
    pub fn get_lista_id_midias(&self) -> &Vec<String> { &self.lista_id_midias }
}
